...
// CHECK-ANDROID-ARM-LD: Inputs/basic_android_tree/bin{{/|\\+}}ld.lld
...
// CHECK-ANDROID-ARM-LD-TC: Inputs/basic_android_tree/lib/gcc/arm-linux-androideabi/4.4.3/../../../../arm-linux-androideabi/bin{{/|\\+}}ld.lld
